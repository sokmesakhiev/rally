      ...
      <main className="mx-auto max-w-2xl px-5 py-10">
        <div>
          ...
          <p className="mt-1 text-muted-foreground">
            {user?.email_auto_generated ? (user?.phone ?? t("profile.noContactYet")) : user?.email}
          </p>
        </div>
          ...
          <div className="mt-8 space-y-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  {user?.email_auto_generated
                    ? t("profile.changeEmailDescAutoGenerated")
                    : t("profile.changeEmailDesc", { email: user?.email })}
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="space-y-2">
